...
public class FloatingActionButton extends ImageButton {
	...
	void init(Context context, AttributeSet attributeSet) {
		...
		mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(R.color.blue_500));
		mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(R.color.blue_700));
		mColorDisabled = attr.getColor(R.styleable.FloatingActionButton_fab_colorDisabled, getColor(R.color.light_grey_500));
